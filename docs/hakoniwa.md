...
- ポータル: 現世で glowstone（西）→ ネザー、end stone（東）→ エンド。帰還は各次元の西の **glowstone**（エンドの床は end stone のため）。チャット `/dim` でも切替。転送後しばらくポータル無効。
- Mob (H4): 現世にブタ／ウシ（ふらつき）とゾンビ（追尾・接触ダメージ）、ネザーにゾンビ化ピグリン、エンドにエンダーマン。殴って倒せる。
- 液体 (H5): 流動なしの水源／溶岩源。水・溶岩は非固体（入れる／溶岩ダメージ）。泳ぎ演出はクライアント任せ。
- コンテナ (H6): スポーン北のチェストを右クリックで開く（手持ちブロックでも開く）。
